  ...
  function (d3Interpolate, V, versionCompare, Filter, helper) {
    ...
    return function (filterManager) {
      ...
      self.setData = function setData(data) {
        ...
        var uplinkDict = count(nodes, ['uplink'], function (d) {
          return d ? _.t('yes') : _.t('no');
        });
        ...
        uplinkTable = fillTable('node.uplink', uplinkTable, uplinkDict.sort(function (a, b) {
          return b[1] - a[1];
        }));
      ...
      self.render = function render(el) {
        ...
        self.renderSingle(el, 'node.uplink', uplinkTable);
