module.exports = function () {
  return {
    ...
    'nodeInfos': [
      {
        ...
        'href': 'https://map.freifunk-3laendereck.net/grafana/d/000000078/freifunk-sackingen-einzelansicht?var-Knotenid={NODE_ID}&theme=light',
        'image': 'https://map.freifunk-3laendereck.net/grafana/render/d-solo/000000078/freifunk-sackingen-einzelansicht?refresh=5m&orgId=1&panelId=3&var-Knotenid={NODE_ID}&width=528&height=290&theme=light',
    ...
    'globalInfos': [
      {
        'name': 'Tagesstatistik',
        'href': 'https://map.freifunk-3laendereck.net/grafana/d/000000077/freifunk-sackingen-history?theme=light',
        'image': 'https://map.freifunk-3laendereck.net/grafana/render/d-solo/000000077/freifunk-sackingen-history?refresh=5m&orgId=1&panelId=1&width=528&height=290&theme=light',
        'title': 'Bild mit Tagesstatistik'
      },
      {
        'name': 'Wochenstatistik',
        'href': 'https://map.freifunk-3laendereck.net/grafana/d/000000077/freifunk-sackingen-history?theme=light',
        'image': 'https://map.freifunk-3laendereck.net/grafana/render/d-solo/000000077/freifunk-sackingen-history?refresh=5m&orgId=1&panelId=2&width=528&height=290&theme=light',
    ...
    geo: [
      {
        json: function () {
          return require('helper').getJSON('https://map.freifunk-3laendereck.net/geojson/saek.geojson').then(function (result) {
